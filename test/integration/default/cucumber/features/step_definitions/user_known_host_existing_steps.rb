...
Given(/there are existing entries/) do
  existing_entries = 'github.com,192.30.252.128 ssh-rsa '
  cmd = "echo '#{existing_entries}' > #{@host_file}"
  `#{cmd}`
end

When(/^the node has new known host entries$/) do
...
Then(/^new entries are appended and the existing entries are preserved$/) do
  ...
  github_key_host_type = Regexp.escape('github.com,192.30.252.128,192.30.252.129 ssh-rsa')
